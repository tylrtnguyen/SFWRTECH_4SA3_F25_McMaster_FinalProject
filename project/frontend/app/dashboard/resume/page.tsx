...
export default function ResumePage() {
  ...
  const [analyzingResume, setAnalyzingResume] = useState<ResumeData | null>(null)
  const [lastAnalyzedResume, setLastAnalyzedResume] = useState<ResumeData | null>(null)
  ...
  const handleAnalysis = useCallback(async (resume: ResumeData, force: boolean = false) => {
    ...
    <div className="space-y-8 px-4 md:px-8 lg:px-16 xl:px-24 max-w-7xl mx-auto">
      ...
      <div className="space-y-3">
        ...
        <p className="text-text-secondary dark:text-[#b0b3b8]">
          Upload and manage your resumes. Get AI-powered tips to optimize for specific jobs.
        </p>
      </div>
          ...
          {resumes.length === 0 && (
            <Card className="p-12 text-center">
              ...
              <p className="text-muted-foreground mb-6 max-w-md mx-auto">
                Upload your first resume to get started. Our AI will analyze it and provide personalized tips to help you land your dream job.
              </p>
